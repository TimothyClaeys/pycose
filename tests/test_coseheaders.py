...
@pytest.mark.parametrize("params, encoded_phdr",
                         [
                             ({1: 10}, b'A1010A'),
                             ({HeaderKeys.ALG: CoseAlgorithm.AES_CCM_16_64_128}, b'A1010A'),
                             ...
                             ({HeaderKeys.ALG: CoseAlgorithm.AES_CCM_16_128_128}, b'A101181E')
...
@pytest.mark.parametrize("params, encoded_uhdr",
                         [
                             ...
                             ({HeaderKeys.ALG: CoseAlgorithm.AES_CCM_16_64_128}, {1: 10}),
...
@pytest.mark.parametrize("params, encoded_uhdr",
                         [
                             ...
                             ({HeaderKeys.ALG: 10, HeaderKeys.IV: b'02D1F7E6F26C43D4868D87CE'},
                              {1: 10, 5: b'02D1F7E6F26C43D4868D87CE'}),
                             ({HeaderKeys.ALG: CoseAlgorithm.A256GCM, HeaderKeys.IV: b'ae8987be9874f98ebb'},
...
@pytest.mark.parametrize("params, expected", [({1: -25}, b'a1013818'),
                                              ...
                                              ({HeaderKeys.ALG: CoseAlgorithm.EDDSA,
...
@pytest.mark.parametrize("params, expected",
                         [
                             ({1: CoseAlgorithm.DIRECT, HeaderKeys.KID: b'our-secret'}, {1: -6, 4: b'our-secret'}),
