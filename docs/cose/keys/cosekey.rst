...
The :class:`~cose.keys.cosekey.CoseKey` class is the abstract base class for all COSE key types:

* The :class:`~cose.keys.okp.OKPKey` type
* The :class:`~cose.keys.ec2.EC2Key` type
* The :class:`~cose.keys.symmetric.SymmetricKey` type

The :class:`~cose.keys.cosekey.CoseKey` class can be used to decode serialized COSE keys.
